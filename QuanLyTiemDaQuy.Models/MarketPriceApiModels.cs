...
namespace QuanLyTiemDaQuy.Models
{
    ...
    public class MarketPriceApiResult
    {
        ...
        public List<GemstoneMarketPriceData> Prices { get; set; } = new List<GemstoneMarketPriceData>();
    ...
    public static class GemstoneReferencePrices
    {
        ...
        /// </summary>
        public static readonly Dictionary<string, GemstoneReferenceData> ReferencePrices = new Dictionary<string, GemstoneReferenceData>
        {
